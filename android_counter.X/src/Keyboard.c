/********************************************************************
//pic18f2550 changes:
//1. HardwareProfile.h, line 86 add |(__18F2550)
//2. HardwareProfile - PICDEM FSUSB.h comment line 82
//3. linker files removed from project (rm18f4550)
//4. main.c change to #pragma config PLLDIV   = 1         // (4 MHz crystal on PICDEM FS USB board) 
...
//        
			ADCON1 = 0b1101;		//pins 2,3 analogue 
    #elif defined(__C30__) || defined __XC16__
...
{
//	
	TRISCbits.TRISC0=1;	//counter's input
	//TRISBbits.TRISB4=1;
	//TRISBbits.TRISB5=0;
	TRISAbits.TRISA0=1;
 	TRISAbits.TRISA1=1;
...
void ProcessIO(void)
{   
    unsigned char timebase, freq3, k0;
    unsigned int volt ;
...
//Frequency Counter
	        ...
	        PIR1bits.TMR1IF = 0;
	        PIR1bits.TMR2IF = 0;
	        //PORTBbits.RB5 = ReceivedDataBuffer[1];		//1 sec time base LED
	        //if(ReceivedDataBuffer[1]){timebase = 200;}	//time base=1 sec
	        //else{timebase = 20;}
	        timebase = 200;	//time base=1 sec
	        ...
	        frequency = (unsigned long)freq3 * 65536 + (unsigned long)TMR1H * 256 + (unsigned long)TMR1L;
	        k[0]=5;
	        k[2]=(frequency/1000000) %10 + 29;
			k[4]=(frequency/100000) %10 + 29;
			k[6]=(frequency/10000) %10 + 29;
	        k[8]=(frequency/1000) %10 + 29;
			k[10]=(frequency/100) %10 + 29;
			k[12]=(frequency/10) %10 + 29;
			k[14]=frequency %10 + 29;
			k[16]=6;
	        
	        volt = (unsigned int)ADRESH * 256 + (unsigned int)ADRESL;
	        k[18]=7;
	        k[20]=(volt/1000) %10 + 29;
			k[22]=(volt/100) %10 + 29;
			k[24]=(volt/10) %10 + 29;
			k[26]=(volt %10) + 29;
			k[28]=8;
			
			k[1]=k[3]=k[5]=k[7]=k[9]=k[11]=k[13]=k[15]=k[17]=k[19]=k[21]=k[23]=k[25]=k[27]=k[29]=9;
